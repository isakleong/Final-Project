...
if(isset ($_POST['predict'])){
    ...
    //shell exec model
    $cmd = "\"D:/Kuliah/Semester_8/Skripsi/Training Model/call.py\" $teks";
    $c = shell_exec($cmd);

    $c = trim(preg_replace('/\s\s+/', ' ', $c));

    //query update model_predict column on aspirasi table
    $sql="UPDATE aspirasi set model_predict='$c' WHERE id_aspirasi='$id_aspirasi'";
    $res = $con->query($sql);

    $alert_content = 'aspirasi berhasil diklasifikasi';
    echo '<script type="text/javascript">alert("'.$alert_content.'");</script>';
    echo "<script> location='aspirasi_prediksi'; </script>";
}
...
<head>
    ...
    <title>Detail Aspirasi Prediksi - Petra Complaint</title>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><a href="aspirasi_prediksi">Aspirasi Prediksi</a></li>
                                <li><span>Detail Aspirasi Prediksi</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Data Detail Aspirasi Prediksi</h4>
                                        <p class="text-muted font-14 mb-4">Silahkan melakukan prediksi label kelas biro / unit untuk aspirasi civitas akademika</p>
                                        <form method="POST" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" name="predict" class="btn btn-primary mt-4 pr-4 pl-4">Prediksi Kelas Aspirasi</button>
                                            <?php } ?>
                                        </form>
                                    </div>
                                </div>
